...
public class Loader {
    ...
    public RawModel loadVAO(float[] positions, float[] textureCoords, float[] normals, float[] tangets, int[] indices) {
        int vaoID = createVAO();
        bindIndicesBuffer(indices);
        storeDataInAttributeList(0, 3, positions);
        storeDataInAttributeList(1, 2, textureCoords);
        storeDataInAttributeList(2, 3, normals);
        storeDataInAttributeList(3, 3, tangets);
        unbindVAO();
        return new RawModel(vaoID, indices.length);
    }
    ...
    /**
     * Textures must be specified in this order:
     *      right face
     *      left face
     *      top face
     *      bottom face
     ...
     *      front face
     * 
     * texture info: https://open.gl/textures
     * 
     * @param textureFiles
     * @return
     */
